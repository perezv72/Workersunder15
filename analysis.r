...
for(i in 1:51){
  ...
  t_u15 <- as.integer(t_state*p_state)
  ...
  t_female_u15 <- as.integer(t_female*p_female)
  ...
  t_latinx_u15 <- as.integer(t_latinx*p_latinx)
  ...
  t_black_u15 <- as.integer(t_black*p_black)
  ...
  t_youth_u15 <- as.integer(t_youth*p_youth)
